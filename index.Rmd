...
source("components/highChartRadialBarStatic.R")
source("components/highChartRadialBarDynamic.R")
...
renderHighchart(
  HighChartRadialBarDynamic(
    .data = casesAgeGroup,
    .yTitle = stateAgeGroupCasesYAxisTitle
  ) %>%
    StyleRadialBarDynamic()
)
...
### `r renderUI(HTML("<h5 class='chart-title-text'>Total Deaths by Age Group</h5>"))`
...
stateAgeGroupChartData <- eventReactive(
  c(input$stateAgeGroupMetric, input$stateAgeGroupChartType), {
    chosenMetric <- switch(
...
renderHighchart({
  HighChartMultiLineDate(
    .data = stateAgeGroupChartData,
    .yTitle = stateAgeGroupYAxisTitle
  ) %>%
    StyleMultiLineDate(
      .yTitle = stateAgeGroupYAxisTitle,
