...
=======
>>>>>>> 8bad918c98ff7c0808e79652b37a8dec1561871f
...
# reactive value to store the quick summary chart title
rv$localityQuickSummaryTitle <- 
  "<h5 class='chart-title-text'>Quick Summary</h5>"
...
# reactive object for quick summary data
# FIRES ON METRIC VALUE CHANGE
quickSummaryData <- eventReactive(
  input$mapClick, {
    totals <- covid$LCMS %>%
      filter(Locality == chosenLocality()) %>%
      select(
